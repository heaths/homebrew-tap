class Akv < Formula
  ...
  url "https://github.com/heaths/akv-cli-rs/archive/refs/tags/v0.7.0.tar.gz"
  sha256 "66e62a365f01e0774e1d8614f81ba64174e0eb8430b0657b9742ff6d4a806deb"
  license "MIT"
  ...
  def install
    ...
    shell_output("ls -l #{bin}")
    shell_output("#{bin}/akv --version")
